    ...
    <ul class="header-nav ms-auto">
        <li class="nav-item">
            <a class="nav-link" href="#">
                <svg class="icon icon-lg">
                    <use xlink:href="coreui/vendors/@coreui/icons/svg/free.svg#cil-cart"></use>
                </svg>
            </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                ...
                <div class="avatar avatar-md">
                    <img class="avatar-img" src="coreui/assets/img/avatars/default.jpg" alt="user@email.com">
                </div>
            </a>
            <div class="dropdown-menu dropdown-menu-end pt-0">
                ...
                <a class="dropdown-item" href="{{ url('coreui/account/profile') }}">
                    <svg class="icon me-2">
                        <use xlink:href="coreui/vendors/@coreui/icons/svg/free.svg#cil-user"></use>
                    </svg> Profile</a>

                <a class="dropdown-item" href="{{ url('coreui/account/edit-password') }}">
                    <svg class="icon me-2">
